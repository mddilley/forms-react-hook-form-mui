...
## Mission: Build web forms with react-hook-form and Material UI
### (Let's make forms easy for everyone)
## 🚀👩‍🚀 Discovery Day v4 👨‍🚀🚀
...
- Fetching options: Sometimes, options are dynamic so we have to request them from a database.

- Autocomplete: Let's make long lists of options easier.
...
- Fast because it directly manipulates the DOM, ex. 🍔🍟 
